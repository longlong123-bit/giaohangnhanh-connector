...
class PartnerVTPost(models.Model):
    ...
    ghn_province_id = fields.Many2one('ghn.province', string='Province')
    ghn_district_id = fields.Many2one('ghn.district', string='District')
    ghn_ward_id = fields.Many2one('ghn.ward', string='Ward')
